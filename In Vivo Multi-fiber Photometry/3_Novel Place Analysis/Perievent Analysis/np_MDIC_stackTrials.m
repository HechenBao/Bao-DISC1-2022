...
% %Old place
% subplot(2,4,1)
% imagesc(sortrows(rasterOld_IC,31,'descend'))
% %xlim([0 before+after])
% title('IC Old Place')
% caxis([-1 2]);
% colorbar;
% subplot(2,4,2)
% plot(t,mean(rasterOld_IC))
% xlim([t(1) t(length(t))])
% hold on
% 
% subplot(2,4,5)
% imagesc(sortrows(rasterOld_MD,31,'descend'))
% %xlim([0 before+after])
% title('MD Old Place')
% caxis([-1 2]);
% colorbar;
% subplot(2,4,6)
% plot(t,mean(rasterOld_MD))
% xlim([t(1) t(length(t))])
% hold on
% 
% %Novel place
% subplot(2,4,3)
% imagesc(sortrows(rasterNovel_IC,31,'descend'))
% %xlim([0 before+after])
% title('IC Novel Place')
% caxis([-1 2]);
% colorbar;
% subplot(2,4,4)
% plot(t,mean(rasterNovel_IC))
% xlim([t(1) t(length(t))])
% hold on
% 
% subplot(2,4,7)
% imagesc(sortrows(rasterNovel_MD,31,'descend'))
% %xlim([0 before+after])
% title('MD Novel Place')
% caxis([-1 2]);
% colorbar;
% subplot(2,4,8)
% plot(t,mean(rasterNovel_MD))
% xlim([t(1) t(length(t))])
% hold on
